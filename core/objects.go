...
// DNSAccountPrefix is the prefix for the DNS account challenge
// It is used in the dns-account-01 challenge to create a unique subdomain
// for each account, allowing multiple independent ACME clients to perform
// domain validation concurrently.
const DNSAccountPrefix = "_"

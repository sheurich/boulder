...
type PerformValidationRequest struct {
	...
	AccountURI               string            `protobuf:"bytes,6,opt,name=accountURI,proto3" json:"accountURI,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *PerformValidationRequest) GetAccountURI() string {
	if x != nil {
		return x.AccountURI
	}
	return ""
...
var file_va_proto_rawDesc = string([]byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x72, 0x69, 0x72, 0x22, 0x96, 0x02, 0x0a, 0x18, 0x50, 0x65, 0x72, 0x66,
	...
	0x4b, 0x65, 0x79, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x55, 0x52, 0x49, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x55, 0x52, 0x49,
